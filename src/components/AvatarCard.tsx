    ...
    return (
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-sm text-black mb-1">{avatar.description}</p>
  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <h3 className="font-semibold text-black mb-2 text-center">
          {avatar.name}
        </h3>
        <p className="text-sm text-black text-center mb-3 line-clamp-2">
          {avatar.description}
        </p>
